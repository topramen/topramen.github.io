...
with Random Forest giving an error of 0.005 (which is 1 minus 0.995) or 1 out of 200.

### Prediction
Let's predict with the best models noted earlier, Random Forest. Given that the cross-validation error of this model was 1/200, the chance of getting an out-of-sample error in a testing set of 20 is pretty small.
